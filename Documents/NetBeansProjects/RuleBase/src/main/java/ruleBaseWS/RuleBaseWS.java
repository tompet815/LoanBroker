...
public class RuleBaseWS {
    ...
    public String getRelevantBanks( @WebParam( name = "creditScore" ) int creditScore ) throws JAXBException, IOException {
        ...
        String result = "banks";
        for ( String bank : relevantBanks ) {
            result += ", " + bank;
        }

        RuleBaseResponse response = new RuleBaseResponse( result );
...
//         marshaller.marshal(je2, new File("c:/temp/banks.xml"));
